...
for line in sample_list:
	...
	#Align and call variants
        ...
        command = "docker run -it --rm=true -v /home/ec2-user/GekSan_vcfs:/home wengkhong/vcflib vcflib/bin/vcffilter -f 'DP > 19 & QUAL > 30' /home/" + sample_name + ".vcf > " + sample_name + ".filtered.vcf"
        print command
        call(command, shell = True)
        print "Getting variants in target region"
        command = "docker run --rm=true -v /home/ec2-user/GekSan_vcfs:/home wengkhong/vcflib bedtools intersect -u -a /home/" + sample_name + ".filtered.vcf -b /home/GS_Panel.bed > " + sample_name + ".filtered.target.vcf"
        print command
        call(command, shell = True)
	#Uploaldd results
